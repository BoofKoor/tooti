 ...
 * reads as a phone) with a scrollable content region. The whole learning journey
 * lives in the Learn path, so there's no bottom tab bar — Profile is reached from
 * the avatar in the path header, and Welcome ('/') and the lesson runner live
 * outside this shell too.
 *
